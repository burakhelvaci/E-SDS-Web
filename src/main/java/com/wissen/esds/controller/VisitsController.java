...
public class VisitsController {
    ...
    @RequestMapping(value = "/visit/addvisit", method = RequestMethod.POST)
    public String insertVisit(Model model, Visit visit) {
        databaseService.insert(visit);
        return "redirect:/visit";
    }

    @RequestMapping(value = "/visit/updatevisit", method = RequestMethod.POST)
    public String updateVisit(Model model, Visit visit) {
        databaseService.update(visit);
        return "redirect:/visit";
    }

    @RequestMapping(value = "/visit/deletevisit", method = RequestMethod.POST)
